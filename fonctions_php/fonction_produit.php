<?php  
    ...
    function afficher_moyenne_note($moyenne){
        ...
        for ($i =1; $i <= floor($moyenne); $i++){
            ?> <img src="../html/images/etoile_pleine.svg" alt="étoile pleine"><?php
        }
        if(fmod(floor($moyenne*2),2)){
            ?> <img src="../html/images/etoile_demi.svg" alt="étoile à moitié pleine"> <?php 
        }
        for ($i =5; $i > round($moyenne); $i--){
            ?> <img src="../html/images/etoile_vide.svg" alt="étoile vide"><?php
        }
    }
?>