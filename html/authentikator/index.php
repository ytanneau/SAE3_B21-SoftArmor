...
<body id="connect_<?=$vendeur ? 'vendeur' : 'client'?>">
    <main>
        ...
        <form action="" method="post">
            <label>Ouvrez l'application où vous avez entré votre clef de double authentification, et entrez ci-dessous le code PIN affiché pour vous connecter</label>
